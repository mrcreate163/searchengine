...
Однако для больших продакшен-систем рекомендуется использовать инструменты миграции базы данных (например, Flyway или Liquibase) для более контролируемого управления схемой.
